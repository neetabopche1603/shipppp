		...
		<div class="col-md-9">
            ...
            @csrf
                <div class="contact-form">
                    ...
                    <div class="col-sm-10">          
                        <input type="text" class="form-control" value="{{ old('title') }}" id="title" placeholder="Enter Advertisment Title" name="title">
						@error('title')
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="description" placeholder="Describe Your Advertisment" rows="5" id="description">{{ old('description') }}</textarea>
					</div>
					</div>
					@error('descrption')
					<small id="usercheck" style="color: red;" >
