        ...
        <form action="updateProfile" method="POST" enctype="multipart/form-data">
                ...
                <div class="image-upload d-flex flex-column align-items-center text-center p-3 py-5">
                    <label for="file-input">
                        <img class="rounded-circle mt-5" width="200px" height="200px" src="{{ asset('image/'. $data->profileimage) }}"/>
                        <span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"  style="float:left !important; " id="myModalLabel">Image Preview</h5>
        <button type="button"  style="float:right !important; " class="btn btn-info text-white rounded-circle btn-sm" id="closemodal" data-dismiss="modal">X</button>
      </div>
      <div class="modal-body">
        <img src="{{ asset('image/'. $data->profileimage) }}" id="imagepreview" style="width: 100%; height: 100%;" >
      </div>
